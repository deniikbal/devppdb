...
class PrintFormulirController extends Controller
{
    ...
    public function printformulir(Student $student)
    {
        ...
        $this->pdf->Ln(5);
        $this->pdf->Image($pasfoto,140,60,40,60);
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,Str::title($student->name),'0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'3273175007040004','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'085722676819','0',1,'L');

        $this->pdf->Cell(55,5,'Anak Ke','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'1','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'170','0',1,'L');

        $this->pdf->Cell(55,5,'Berat Badan','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'60','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'20228479','0',1,'L');

        $this->pdf->Cell(55,5,'Provinsi SMP/MTs','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Jawa Barat','0',1,'L');

        $this->pdf->Cell(55,5,'Kabupaten SMP/MTs','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Majalengka','0',1,'L');

        $this->pdf->Cell(55,5,'Kecamatan SMP/MTs','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Bantarujeg','0',1,'L');

        $this->pdf->Cell(55,5,'Desa / Kelurahan SMP/MTs','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Wadowetan','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'1234567890123456','0',1,'L');

        $this->pdf->Cell(55,5,'Nama Ayah','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Deni Muhamad Ikbal','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'1987','0',1,'L');

        $this->pdf->Cell(55,5,'Pendidikan Ayah','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'SMP Sederajat','0',1,'L');

        $this->pdf->Cell(55,5,'Pekerjaan Ayah','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Karyawan Swasta','0',1,'L');

        $this->pdf->Cell(55,5,'Penghasilan Ayah Ayah','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Rp. 500,000 - Rp. 999,999','0',1,'L');
        ...
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'Dsn. Cidomas RT 10 RW 06','0',1,'L');

        $this->pdf->Cell(55,5,'Jarak Rumah Ke Sekolah','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'10 Km','0',1,'L');

        $this->pdf->Cell(55,5,'Waktu Tempuh','0',0,'L');
        $this->pdf->Cell(5,5,':','0',0,'L');
        $this->pdf->Cell(1,5,'','0',0,'L');
        $this->pdf->Cell(50,5,'20 Menit','0',1,'L');
        ...
        $this->pdf->Cell(60,6,'Nama Kegiatan','1',0,'C', true);
        ...
        foreach ($prestasi as $item){
            ...
            $this->pdf->Cell(60,6,$item->nama_kegiatan,'1',0,'L');
        ...
        //$this->pdf->Output('D','Formulir Peserta-'.$student->name.'.pdf');
        $this->pdf->Output();
