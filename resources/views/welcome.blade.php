    ...
    <section id="hero" class="hero d-flex align-items-center">
        <div class="container">
            <div class="row">
                                    ...
                                    @else
                                        <div class="text-center text-lg-start">
                                            <a href="{{ route('students.index') }}" target="_blank"
                                                class="btn btn-danger d-inline-flex align-items-center justify-content-center align-self-center">
                                                <i class="bi bi-person-plus-fill ml-2"></i> <span>Student</span>
                                            </a>
                                        </div>
                                    @endif
                                @else
                ...
                <div class="modal" id="register" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                        ...
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0"
                                    data-purecounter-end="{{ $kuota->jumlah_pendaftar }}"
                                    data-purecounter-duration="1" class="purecounter"></span>
                ...
                <div class="row gy-4" data-aos="fade-left">
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <img src="{{ asset('/assets/img/pricing-free.png') }}" class="img-fluid"
                                alt="" />
