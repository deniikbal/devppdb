...
<head>
    ...
    <title>PPDB SMA TELKOM BANDUNG TEST</title>
                        ...
                        <div class="col-xl-8 d-flex content">
                            <div class="row align-self-center gy-4">
                                <div class="col-md-6 icon-box" data-aos="fade-up">
                                    ...
                                    <div>
                                        <h4>Pendaftaran</h4>
                                        <p>Untuk pendaftaran bisa online dengan mengisi data diweb ppdb atau
                                            datang
                                            langsung ke Sekolah SMA Telkom Bandung</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <div>
                                        <h4> Membayar Biaya Daftar Ulang</h4>
                                        <p>Silahkan membayar biaya daftar Ulang</p>
                                    </div>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-box red">
                        ...
                        <p>1 September s/d 31 Desember 2021</p>
                        <strong>
                            <p>Jalur Reguler 1</p>
                        </strong>
                        <p>1 September s/d 31 Desember 2021</p>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-box red">
                        ...
                        <p style="font-size: 12px">Akademik /Non Akademik / Tahfidz Qur'an</p>
                        <p>1 Januari s/d 31 Maret 2022</p>
                        <strong>
                            <p>Jalur Reguler 2</p>
                        </strong>
                        <p>1 Januari s/d 31 Maret 2022</p>
