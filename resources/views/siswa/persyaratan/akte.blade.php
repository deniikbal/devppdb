...
@section('content')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Akte Kelahiran</li>
                </ol>
            </nav>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="container">
                <input type="file" class="filepond" id="akte" name="akte" data-allow-reorder="true"
...
@section('script')
    <script>
        ...
        const inputElement = document.querySelector('input[id="akte"]');
