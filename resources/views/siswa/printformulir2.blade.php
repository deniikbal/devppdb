...
<body style="font-family: 'Roboto', sans-serif">
    ...
    <table style="text-align:left;">
        <tr>
            <td style="">
                <img src="{{ asset('assets/img/logots.png') }}" style="height: 100px;margin-top: 5px" />
            </td>
            <td style="">
                <b class="ukuran">PPDB SMA TELKOM BANDUNG</b><br>
                <b class="ukuran2">https://ppdb.smatelkombandung.sch.id/</b>
            </td>
        </tr>
    </table>
    <hr style="border-color: black; margin-bottom:2px">
    <p class="text-center h3 mt-3" style="font-family: 'Roboto Mono', monospace">Formulir Pendaftaran PPDB Tahun 2023</p>
    <p class="text-left h5 mt-2">Data Pribadi Pendaftar</p>
