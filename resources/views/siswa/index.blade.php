...
@section('content')
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{route('student.profile', $student)}}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control @error('agama') is-invalid @enderror" name="agama" id="">
                            <option value="">--Pilih--</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control @error('hoby') is-invalid @enderror" name="hoby" id="">
                            <option value="">--Pilih--</option>
                    ...
                    <div class="col-sm-3">
                        <select class="form-control @error('cita') is-invalid @enderror" name="cita" id="">
                            <option value="">--Pilih--</option>
        ...
        <div class="card-footer d-flex justify-content-between">
            ...
            <a href="{{route('editsekolah', $student)}}" class="btn btn-primary">
