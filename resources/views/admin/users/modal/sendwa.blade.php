<div id="sendwauser{{$user->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="label-modal-confirm" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-14">
            ...
            <form action="{{route('sendwauser', $user->id)}}" method="post">
                @method('PUT')
                @csrf
