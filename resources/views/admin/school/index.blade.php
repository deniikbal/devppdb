        ...
        <div class="card-body">
            <table id="example2" class="table">
                ...
                <tr>
                    ...
                    <th class="wd-25p">Nama Sekolah</th>
                    <th class="wd-20p">NPSN</th>
                ...
                @foreach($schools as $school)
                    <tr>
                        ...
                        <td>
                            Desa : {{$school->desa}}<br>
                            Kecamatan : {{$school->kecamatan}}<br>
                            kabupaten : {{$school->kabupaten}}<br>
                            Provinsi : {{$school->provinsi}}<br>
                        </td>
                        <td>

                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                    data-target="#edit{{$school->id}}">
                            ...
                            <form onclick="return confirm('yakin mau dihapus??')"
                                  action="{{route('school.destroy', $school->id)}}" method="post"
                    ...
                    @include('admin.school.modal.edit')
                @endforeach
                </tbody>
            </table>
        </div>
