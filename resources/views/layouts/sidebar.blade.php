    ...
    <div class="aside-body">
        <div class="aside-loggedin">
            <div class="d-flex align-items-center justify-content-start">
                ...
                @endphp
                <a href="" class="avatar avatar-xxl"><img src="{{ asset('storage/' . Auth::user()->avatar) }}" class="rounded-circle" alt=""></a>
        ...
        <ul class="nav nav-aside">
            ...
            <li class="nav-item with-sub">
                <a href="" class="nav-link"><i data-feather="file"></i> <span>Semester</span></a>
                <ul>
                    <li><a href="{{route ('semesters.index')}}">Timeline</a></li>
                </ul>
            </li>
